...
const Navbar = () =>{
    ...
    return (
        <div className='bg-base-200'>
            ...
            <div>
                <NavLink to="/" className='sm:font-bold'>Home</NavLink>
                <NavLink to="/allSport" className='ml-4 sm:font-bold'>All Sports Equipment</NavLink>
                <NavLink to="/addEquipment" className='ml-4 sm:font-bold'>Add Equipment</NavLink>
                <NavLink to={`/equipment/${user?.email}`} className='ml-4 sm:font-bold'>My Equipment List</NavLink>
            </div>
            <div className='flex'>
                {
                    user?.email ? (
