...
const Register = () => {
  ...
  const handleGoogleLoginTwo = () =>{
    ...
    return (
        <>
            <form action="" onSubmit={handleSubmit} className="card-body bg-base-300 w-11/12 mx-auto min-h-screen md:w-1/2 rounded-lg my-10">
            ...
            <div className="form-control mt-6">
                <button onClick={handleRegister} className="btn w-full bg-green-500" >
                Register
                </button>
            </div>
